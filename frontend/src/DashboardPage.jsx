        ...
        <div className="mt-12 bg-gradient-to-r from-blue-50 to-purple-50 rounded-xl p-8 border border-blue-100">
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1">
              <h3 className="text-lg font-bold text-gray-900 mb-1">Need help getting started?</h3>
              <p className="text-gray-600 mb-4">Check out our quick start guide or contact support for assistance.</p>
              <div className="flex gap-3">
                <a href="#" className="inline-flex items-center px-4 py-2 bg-blue-600 text-white rounded-lg font-medium hover:bg-blue-700 transition-colors">
                  View Guide
                </a>
                <a href="#" className="inline-flex items-center px-4 py-2 bg-white text-gray-700 rounded-lg font-medium hover:bg-gray-50 transition-colors border border-gray-300">
                  Contact Support
                </a>
              </div>
            </div>
